...
## Multi-dimensional scaling {.tabset .tabset-fade}
...
for (i in design_files){
  sce <- get(gsub("SAMPLE_FILE",i , "sce.SAMPLE_FILE"))
  cat("### ",i,"\n")
  p <- plotMDS(sce, color_by = "condition")
  print(p)
  cat('\n\n')
}
```
...
for (i in design_files){
  sce <- get(gsub("SAMPLE_FILE",i , "sce.SAMPLE_FILE"))
  cat("### ",i,"\n")
  p <- plotExprHeatmap(sce, bin_anno = TRUE, row_anno = TRUE)
  print(p)
  cat('\n\n')
}
```
...
for (i in design_files){
  ...
  sce <- cluster(sce, features = lineage_markers$antigen, 
...
for (i in design_files){
  ...
  cat("### ",i,"\n")
  p <- plotClusterExprs(sce, k = "meta8", features = "type")
  print(p)
  cat('\n\n')
}
```
...
for (i in design_files){
  ...
  cat("### ",i,"\n")
  p <- plotClusterHeatmap(sce, hm2 = "abundances", draw_freqs = TRUE, cluster_anno = FALSE)
  print(p)
  cat('\n\n')
}
```
...
for (i in design_files){
  ...
  cat("### ",i,"\n")
  p <- plotAbundances(sce, k = "meta12", by = "sample_id", group_by = "condition")
  print(p)
  cat('\n\n')
}
```
...
for (i in design_files){
  ...
  cat("### ",i,"\n")
  p <- plotAbundances(sce, k = "merging1", by = "cluster_id", group_by = "condition", shape_by = "patient_id")
  print(p)
  cat('\n\n')
}
```
